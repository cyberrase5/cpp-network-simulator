...
class Packet {
    ...
    /**
     * @brief calculates based on params and size_ propagation and transmission delays
     * 
     * @param bandwidth int, represents Kb/s
     * @param latency int, represents ms
     * @note this is not used in the GUI, but the logic is the same
     */
    void wait(unsigned int bandwidth, unsigned short latency) { // BW: Kb/s, latency: ms, size_ KB
        ...
        usleep(1000 * latency); // sleep microseconds * 1000 (ms)

    }

    /**
     * @brief print useful stuff about packet
     * 
     */
    void print() {
